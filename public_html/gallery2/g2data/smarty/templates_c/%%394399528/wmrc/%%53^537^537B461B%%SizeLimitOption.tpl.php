...
// <![CDATA[
function SetSizeLimitOption_toggleXY(chk) {
...
"].disabled = chk;
frm.elements["<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[SizeLimitOption][keepOriginal]"), $this);?>
"].disabled =
chk && frm.elements["<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[SizeLimitOption][sizeChoice]"), $this);?>
"][0].checked;
}
function SetSizeLimitOption_toggleSize(chk) {
var frm = document.getElementById('itemAdminForm');
frm.elements["<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[SizeLimitOption][filesize]"), $this);?>
"].disabled = chk;
frm.elements["<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[SizeLimitOption][keepOriginal]"), $this);?>
"].disabled =
chk && frm.elements["<?php echo $this->_reg_objects['g'][0]->formVar(array('var' => "form[SizeLimitOption][dimensionChoice]"), $this);?>
"][0].checked;
}
// ]]>
</script>
...
"
<?php if ($this->_tpl_vars['SizeLimitOption']['keepOriginal']): ?> checked="checked" <?php endif; ?><?php if ($this->_tpl_vars['SizeLimitOption']['dimensionChoice'] == 'unlimited' && $this->_tpl_vars['SizeLimitOption']['sizeChoice'] == 'unlimited'): ?>
